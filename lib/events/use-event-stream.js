 ...
 *
 * @param {string} eventType - Event type to listen for (e.g., 'job:created', 'notification')
 * @param {function} callback - Called with (data, fullEvent) when an event of this type arrives
 */

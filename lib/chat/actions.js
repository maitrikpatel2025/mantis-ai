...
export async function getUsageBySourceAction(period = '7d') {
  await requireAuth();
  try {
...
export async function getTokenBreakdownByDayAction(days = 7) {
  await requireAuth();
  try {
...
export async function getDashboardChartsAction() {
  await requireAuth();
  try {
...
export async function getCronRunsAction(cronName, limit = 10) {
  await requireAuth();
  try {

...
const conclusionBadgeStyles: Record<string, string> = {
...
interface SwarmWorkflowListProps {
  runs: WorkflowRun[];
}

function SwarmWorkflowList({ runs }: SwarmWorkflowListProps) {
...
export function SwarmPage({ session }: SwarmPageProps) {
  ...
  const fetchPage = useCallback(async (p: number) => {
    try {
      ...
      setRuns((data.runs || []) as unknown as WorkflowRun[]);

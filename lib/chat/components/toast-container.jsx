...
function Toast({ toast, onDismiss }) {
  return (
    <div
      className={`flex items-start gap-3 rounded-lg border px-4 py-3 shadow-lg backdrop-blur-sm animate-slide-in-right cursor-pointer transition-opacity hover:opacity-90 ${TOAST_STYLES[toast.variant] || TOAST_STYLES.info}`}
      onClick={() => {
